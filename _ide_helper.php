 ...
 * Generated for Laravel 5.8.35 on 2020-02-21 17:18:44.
 *
...
namespace Illuminate\Support { 
    ...
    class Str {
         ...
         * @static 
         */ 
        public static function between($subject, $beginning, $end = null)
        {
                        return \Illuminate\Support\Str::between($subject, $beginning, $end);
        }
